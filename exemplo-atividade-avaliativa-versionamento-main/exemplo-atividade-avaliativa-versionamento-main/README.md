...
A gestão deste repositório foi realizada seguindo boas práticas de mercado, utilizando o padrão Conventional Commits para padronização e organização do histórico de commits.
...
Entrar no diretório: cd atividade-ismael

Navegar até a pasta da disciplina desejada utilizando o comando: cd [nome-da-pasta]

Ler o arquivo README.md específico da pasta para instruções detalhadas do projeto.
